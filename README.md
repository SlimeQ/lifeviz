...
- Each source can stack animations (Zoom In, Translate, Rotate) synced to the global animation BPM, with forward or reverse loops plus half/double-time speeds.
