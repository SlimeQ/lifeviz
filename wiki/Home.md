...
- [Fluid Ink, Time Displacement, and Reaction–Diffusion](Field-Simulations.md)
...
- **Bitwise RGB:** `Life Sim` now includes a third life mode that injects the 24 RGB bits of the source image into 24 independent Conway planes and reconstructs visible color from those evolving bit planes.
...
- **Source layers:** scene stacks can combine captured windows, webcams, images/video, generated Color Planes, nested layer groups, and inline simulation groups. Color Planes are capture-free solid RGB sources that default to filling the current canvas without changing its aspect ratio.
