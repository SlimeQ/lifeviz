...
- **Start Recording / Stop Recording** - toggles MP4 capture with a pixel-perfect integer upscale to the nearest HD height (720/1080/1440/2160 when divisible). Recordings are saved to `%UserProfile%\\Videos\\LifeViz` and the taskbar icon shows a red overlay while active.
